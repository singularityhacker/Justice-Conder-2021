...
By [Quadratic Accelerator](https://paragraph.com/@qacc) · 2025-04-07
...
![](https://storage.googleapis.com/papyrus_images/b7fedeafd103fcf66e7347842ecd724a524b24eef6e16060b78cde8b504801d4.png)
...
*   1st Place: People’s Choice Award @ EthDenver: “[WTF is Protocol-Sponsored Tokenization?!](https://www.youtube.com/watch?v=tDotjTDYMR8)”
    
*   Featured in the Onchain Capital Allocation Handbook → [https://www.allo.expert/mechanisms/qacc](https://www.allo.expert/mechanisms/qacc)
    
*   Broad coverage across [CoinMarketCap](https://coinmarketcap.com/community/articles/675afa6ae42f9e0dd07acfb4/), [Altcoin Buzz](https://www.altcoinbuzz.io/cryptocurrency-news/quadratic-accelerator-launches-on-polygon-zkevm/), [Binance](https://www.binance.com/en/square/post/17471786358626), [Benzinga](https://www.benzinga.com/pressreleases/24/12/42463023/qacc-goes-live-on-polygon-zkevm-to-transform-token-launches), [TheNewsCrypto](https://thenewscrypto.com/quadratic-accelerator-launches-on-polygon-zkevm-redefining-token-launches/), [Crypto Daily](https://cryptodaily.co.uk/2024/12/qacc-goes-live-on-polygon-zkevm-to-support-sustainable-token-launches), and others
    

![](https://storage.googleapis.com/papyrus_images/a3b25871bdca0ec27039c75d614ad3047f98a3f7902354f8c8cd62900d314363.png)
...
[Akarun](https://akarun.io/) is a mobile game where players race custom runners tied to live market assets. The fastest runner is linked to the top-performing asset. It's a Defi prediction market disguised as a game. See: [q/acc profile](https://q-acc.giveth.io/project/akarun).

[Prismo](https://prismo.technology/) Technology is a layer-2 hybrid public-private blockchain platform designed to enable secure and scalable solutions for enterprises and government organizations, facilitating the transition of traditional technologies to blockchain. See: [q/acc profile](https://q-acc.giveth.io/project/prismo-technology).

[The Grand Timeline](https://grandtimeline.org/) is a historical research and data visualization project about the entire history of blockchains and Web3. It will be the first interactive and collectible story of its kind. Stay tuned for the NFT launch and 1:1 wearables. See: [q/acc profile](https://q-acc.giveth.io/project/the-grand-timeline).

[x23](https://x23.ai/) is automating the future of decentralized organizations by integrating AI tools to streamline the operation and governance of DAOs, making them more efficient and autonomous. It's the DAO delegates' master terminal. See: [q/acc profile](https://q-acc.giveth.io/project/x23ai).

[Xade Finance](https://xade.finance/) is building the AI-powered Robinhood of DeFi. It is a decentralized platform driven by AI insights and tools that offers a seamless experience for trading and managing digital assets. See: [q/acc profile](https://q-acc.giveth.io/project/xade-finance).

[Citizen Wallet](https://citizenwallet.xyz/) empowers communities and events with Web3 tools to easily launch, use, and manage community tokens via a mobile app and NFC wallets. See: [q/acc profile](https://q-acc.giveth.io/project/citizen-wallet).

[Melodex](https://djookyx.com/) is a decentralized exchange focused on listing asset-backed music tokens. These tokens represent shares in song royalty rights and enable passive income from music monetization. See: [q/acc profile](https://q-acc.giveth.io/project/melodex).

[Ancient Beast](https://ancientbeast.com/) is an open-source, match-based (1v1 or 2v2) eSports strategy game played against other people or AI. It has no chance-based elements and is designed to be easy to learn, fun to play, and hard to master. See: [q/acc profile](https://q-acc.giveth.io/project/ancient-beast).
...
![https://polygonscan.com/tokens/label/quadratic-acceleration?subcatid=0&size=7&start=0&col=3&order=desc](https://storage.googleapis.com/papyrus_images/94ccf0688be6ae7402708b68b61aa24371304c56db2e9fa6fe2d676d18c84765.png)
...
![https://dune.com/qaccteam/qacc-dashboard](https://storage.googleapis.com/papyrus_images/1f19ec86b78b3b159a7aaa2e62210439366ce18018722be5c10d44c5b758469e.png)
...
![](https://storage.googleapis.com/papyrus_images/ed56e026e8b2a34dcccfc937390db8563c737ff2e97218022ebcf972b048a0b4.png)

---

*Originally published on [Quadratic Accelerator](https://paragraph.com/@qacc/q-acc-s1-impact-report)*
