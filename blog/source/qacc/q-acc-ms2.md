...
By [Quadratic Accelerator](https://paragraph.com/@qacc) · 2024-08-21
...
[https://mirror.xyz/qacc.eth/0OFJFRReUBgn2x9nc5XUbEhe4ZmezoOqXG8WHDJoxYg](https://mirror.xyz/qacc.eth/0OFJFRReUBgn2x9nc5XUbEhe4ZmezoOqXG8WHDJoxYg)
...
After extensive testing and changes, [Macro Security](https://0xmacro.com/) provided the final code audit of those contracts. Macro Security has audited code from notable protocols, such as Maker, Thirdweb, and Farcaster. You can read the full report here:

[https://0xmacro.com/library/audits/inverter-1](https://0xmacro.com/library/audits/inverter-1)

The SDK
-------

The essential levers and parameters of the Inverter and q/acc capabilities have been cleanly delineated behind a software development kit (SDK) to create the best possible developer experience. You can dive into the Inverter docs directly [here](https://docs.inverter.network/sdk/quick-start) or explore the q/acc distinctive in this convenient [hackmd](https://hackmd.io/@TGNaoS0SSuSnyQ019YuzBQ/SkX-6VdBR#11-With-the-SDK). Everything needed to deploy a new workflow and configure bonding curve interactions and vesting schedules is listed here. See some of the capabilities made conveniently available with the SDK:

Bonding Curve Interactions

1.  enabling permissioned buying
    
2.  disabling permissioned buying
    
3.  changing buy fees on BC
    
4.  granting buy permissions
    
5.  getting "amount out" for a given BC purchase
...
3.  granting the right to set up vesting
...
*   Gen Orch Factory\_v1: 0xC0c813D16edEd4534C2d9E62099904Ce44500C19
...
![](https://storage.googleapis.com/papyrus_images/f842265e224f7928b5c6dd7d6d9ebbcc1aed72e9972db82ef308d8f2d6df799e.png)
...
![](https://storage.googleapis.com/papyrus_images/7589a10a7df977fef977fb9bc0a5e1385af976fc182bbb02b767451636bcb630.png)
...
*   Go deeper with the knowledge hub. Learn about the program, mechanism parameters and phases, and everything considered in the construction of this project. By doing so, you ensure you stay ahead of the curve. See: [https://bit.ly/qacc-knowledge-hub](https://bit.ly/qacc-knowledge-hub)
    
*   Subscribe. Be sure to follow us on [Farcaster](https://warpcast.com/theqacc), [Twitter](https://x.com/theqacc), and [Mirror](https://mirror.xyz/qacc.eth) and turn on notifications. The next few months are going to fly by, and you don’t want to miss the opportunity to tokenize your favorite project or access the tokens of those who do.
...
[https://mirror.xyz/qacc.eth/2VpX3NdJc0AcoNNKxX0JZ1toCe4CavWY9F189aKSkaE](https://mirror.xyz/qacc.eth/2VpX3NdJc0AcoNNKxX0JZ1toCe4CavWY9F189aKSkaE)

---

*Originally published on [Quadratic Accelerator](https://paragraph.com/@qacc/q-acc-ms2)*
