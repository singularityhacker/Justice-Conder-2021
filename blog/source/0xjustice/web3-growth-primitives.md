...
By [0xJustice.eth](https://paragraph.com/@0xjustice) · 2025-07-07

---

In web3, we face two questions: What to build and how to build it? There are plenty of [ideas](https://thevalueprop.io/database) to answer the first question. All or none of them could work at different times and for various reasons related to investability, market sentiment, and regulation.
...
The “Field of Dreams” philosophy, while common, is sadly not true in Web3. Even the best technology and a first-mover advantage will not prevail if founders haven’t designed for growth. The promise of network effects cuts both ways because to enjoy them, you have to break someone else’s. How much better do you have to be? At least [9x-10x better](https://community.cisco.com/t5/collaboration-blogs/the-9x-effect-for-innovation-adoption/ba-p/3658108). It’s not enough to be better; you need a growth strategy.
...
Competition is like compound interest. You need it working for you, not against you. Platformification is how you do that. You create the conditions for competition where success accrues to you. This approach is similar to applying [Rendanheyi](https://www.linkedin.com/pulse/haiers-rendanheyi-model-blueprint-generative-economy-steiber-2hy3c/) or [3EO](https://www.boundaryless.io/3eo-framework/), but with a focus on impact. It’s an idea that’s catching on. See similar principles at work in Kevin Owocki’s [Funding Festival](https://gov.gitcoin.co/t/gitcoin-3-0-network-first-funding-festival-for-ethereum-s-biggest-problems/20355), Daniel Ospinas’ [Swarm DAOs](https://x.com/_Daniel_Ospina/status/1830914115377721716), and [Grant Ships](https://x.com/grantships).
...
Blockchain protocols are a digital [philosopher’s stone](https://en.wikipedia.org/wiki/Philosopher%27s_stone) of market creation. By designing grants and growth systems as markets, we capitalize on crypto’s most powerful design features preemptively. From the beginning, we’re thinking “in protocols.”
...
The thing you’re trying to grow is itself a piece of software. Grant program leads frequently overlook this. It’s ironic because chains will issue millions in grants while their underlying tech misses out on accelerated development. A powerful tool to address this is [Drips Network](https://www.drips.network/), where money flows directly along software dependency paths. It’s an incredible way to harden the core protocol and attract non-crypto-native open-source developers, as they don’t need a wallet to start receiving rewards.

![](https://storage.googleapis.com/papyrus_images/0944fd8e8b1dc935bd958cec615ded4ef5e95fec2b3cb7aabe4b4b6bf8033a59.gif)

### IRL Activations

Real human interaction in meatspace is valuable because it stokes community, relationships, and networking. IRL hackathons and accelerators are valuable not because of the products produced, but because the human element is sticky. Solana understands this, and it’s why they prioritize localized community building with [Superteams](https://superteam.fun/). Humans don’t thrive living exclusively online. Screen fatigue is real. The most valuable output of your efforts is ecosystem-aligned founders. Listen to Superteam lead, [Kash Dhanda](https://x.com/kashdhanda), explain the vision [here](https://www.youtube.com/watch?v=9GUEwF2l0X8).

![](https://storage.googleapis.com/papyrus_images/e62e458d5af41c1b22e1c228c026a2c1283e2d1c3141fe2abf37941533bfe048.gif)

### Builder Grants

Milestone grants are a crucial component of the funnel and can be layered on top of hackathons or utilized in conjunction with Requests for Proposals (RFPs). While better than lump sum payouts, they come with a significant operational overhead. This cost is easily underestimated, and administration can unexpectedly balloon beyond the initially expected ROI of the program. This highlights the necessity of utilizing entities especially equipped to manage such distribution methods. [Thrive Protocol](https://www.thriveprotocol.com/) is a shining example of a group that has mastered this approach.

![](https://storage.googleapis.com/papyrus_images/e59764b2bec09757f4ffc1f3ff86f25536f77d7a60cc8abb09e9d8b4e7c3c8d2.gif)

### Sponsored Tokenization

Token launchpads deserve a place at this table as first-class growth primitives. Chains should be sponsoring the most promising projects of their funnel. [Protocol-Sponsored Tokenization](https://www.youtube.com/watch?v=tDotjTDYMR8) (PST) ties projects to their ecosystems, allowing communities to influence and participate in the success of new projects. It’s a critical unlock for projects because it provides a series of new strategic levers to the team, including trading fees, token swaps, KPI rewards, and DeFi composability. Many of the [top launchpads](https://defillama.com/protocols/Launchpad) generate more fees than all L2s combined. Leveraging this reality is a secret weapon, and it’s exactly what we’re doing with [q/acc](https://qacc.xyz/), but more on this later.

![](https://storage.googleapis.com/papyrus_images/6265ee42750706c61a6b8f4a754b0e5eeff150fc9d692bf0ec819bb2bdd724d9.gif)

### Retroactive Rewards

I used to heavily criticise retroactive rewards, partly because I found it incredulous that projects could rely on them to build. However, my thinking has evolved, and now I see them as a powerful component if used in combination with other mechanisms. I especially like them when they are used to extract valuable community feedback. Structured in this way, they serve as a temperature check or [NPS score](https://en.wikipedia.org/wiki/Net_promoter_score), providing invaluable data. By requiring all ecosystem stakeholders to rank-choice vote on one another, you drive transactions, qualitative insights, and viral marketing. [Pairwise](https://www.pairwise.vote/) is a highly configurable tool designed to do this very thing.

![](https://storage.googleapis.com/papyrus_images/826f50182da22541e7af80fef091f2184bb0e3987bc5528c2c222a5193ea96a1.gif)

### Dedicated BD

You can push your BD team to [Always Be Closing](https://www.youtube.com/watch?v=GrhSLf0I-HM), but that misses the uniqueness of web3. We’re in the game of crypto economics and systems engineering. If we’re not thinking that way, we should consider a different line of work. BD and growth must be strategically positioned within an ecosystem’s funnel relative to the other components, ultimately fine-tuning the system as a whole.

![](https://storage.googleapis.com/papyrus_images/ad68e0cc9e10809f8f7187dc79b13849e7740108d123b6f9669b6fc5d7bdd8c7.gif)
...
Tokenization is the most overlooked component in today’s systems, yet possibly the most important because it closes your growth circuit. It’s the critical point at which net new value begins to flow back into your system. That’s what we’re designing, [the Quadratic Accelerator](https://qacc.xyz/) (q/acc) to solve. We’re a chain-aligned token launchpad engineered for predictable growth. We scout promising projects, mentor founders, and do token launches with built-in buyer protection and stable price discovery. We’ve launched twelve projects so far and delivered a 13x ROI. No hand waving. Just systematic, repeatable, and measurable growth.

[![User Avatar](https://storage.googleapis.com/papyrus_images/c82ee24a0fa2408f791e9b50ee730db2f47356986db5af049f885ca6b5dd7288.jpg)](https://twitter.com/singularityhack)

[0xJustice.eth 👹🔥](https://twitter.com/singularityhack)

[@singularityhack](https://twitter.com/singularityhack)

[![Twitter Logo](https://paragraph.com/editor/twitter/logo.png)](https://twitter.com/singularityhack/status/1932773650828030419)
...
[![Twitter Logo](https://paragraph.com/editor/twitter/logo.png)](https://twitter.com/theqacc/status/1932770273012691181)

![🚀](https://abs-0.twimg.com/emoji/v2/72x72/1f680.png) Our S2 Impact Report  
...
![](https://storage.googleapis.com/papyrus_images/b81cdb3e6dc4f7d75a747d6e593213542ad0baa1282fab548e8c200ce10fcec2.jpg)

 [![Like Icon](https://paragraph.com/editor/twitter/heart.png) 32](https://twitter.com/singularityhack/status/1932773650828030419)[
...
![](https://storage.googleapis.com/papyrus_images/88798a6ceb9e1ef1b87993d12a475c048902604aaf6b90b795633bd7d216f36f.png)

](https://forms.gle/rrzpz165wv5vtv8x7)

---

*Originally published on [0xJustice.eth](https://paragraph.com/@0xjustice/web3-growth-primitives)*
